...
function Strategy(options, verify) {
  var graphBaseURL = 'https://graph.facebook.com/v2.5';
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://www.facebook.com/dialog/oauth';
  options.tokenURL = options.tokenURL || graphBaseURL + '/oauth/access_token';
  options.scopeSeparator = options.scopeSeparator || ',';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'facebook';
  this._profileURL = options.profileURL || graphBaseURL + '/me';
