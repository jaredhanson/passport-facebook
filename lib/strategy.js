...
var OAuth2Strategy = require('passport-oauth2')
  ...
  , SignedRequestStrategy = require('./signedrequest');
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  // Facebook signed request authentication
  if (req.body && req.body.signed_request) {
    return SignedRequestStrategy.prototype.authenticate.call(this, req, options);
  }
